...
/* $Id: json.c,v 1.2 2011/10/24 08:04:05 kevin Exp $ */
...
function_entry json_functions[] = {
    PHP_FE(json_encode_ex, NULL)
    PHP_FE(json_decode_ex, NULL)
